...
const savedConfig = await getActiveDirectoryConfig();
if (savedConfig) {
setAdConfig({
...
try {
result = await saveActiveDirectoryConfig(adConfigToSave);
} catch (error) {
...
{/* Footer */}
<div className="border-t border-gray-200 p-6 bg-gray-50 flex flex-col sm:flex-row justify-end gap-4">
