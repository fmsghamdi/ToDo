...
const NotificationSystem: React.FC<NotificationSystemProps> = ({
  ...
  return (
    <div className="relative">
      ...
      {showNotifications && (
        <div className={`absolute ${language === 'ar' ? 'right-0' : 'left-0'} bottom-full mb-2 sm:w-96 w-[calc(100vw-1.5rem)] bg-white rounded-lg shadow-lg border border-gray-200 z-50 max-h-96 overflow-hidden`}>
          {/* Header */}
