...
async getActiveDirectoryConfig(): Promise<ActiveDirectoryConfig | null> {
try {
...
async saveActiveDirectoryConfig(config: ActiveDirectoryConfig): Promise<{ success: boolean; message: string }> {
try {
const response = await fetch('/api/ActiveDirectory/config', {
method: 'POST',
headers: {
...
// Export the service instance and separate functions for backward compatibility
export const databaseService = new DatabaseService();

// Export separate functions for easier import
export const getActiveDirectoryConfig = () => databaseService.getActiveDirectoryConfig();
export const saveActiveDirectoryConfig = (config: ActiveDirectoryConfig) => databaseService.saveActiveDirectoryConfig(config);